...
CREATE TABLE pyrdpserver.user(id INT PRIMARY KEY auto_increment, userName varchar(32) , password varchar(32),roleId INT, state INT, stateTime varchar(32), createTime varchar(32), lastModifyTime varchar(32),unique(userName));
...
INSERT INTO pyrdpserver.user ( userName, password ,roleId,state,stateTime,createTime , lastModifyTime )VALUES('user2','111',2,0,NULL,'1403507414000.0','1403507414000.0');
...
CREATE TABLE pyrdpserver.vm(id  INT PRIMARY KEY auto_increment, vmId varchar(32), userName varchar(32) ,vmName varchar(32),ip varchar(32), state INT, stateTime varchar(32),userId INT,createTime varchar(32), lastModifyTime varchar(32),unique(vmId));
INSERT INTO pyrdpserver.vm(vmId ,userName,vmName, ip,state,stateTime,userId,createTime , lastModifyTime) VALUES('1', 'vm1','vm1','192.168.1.107',0,1403507414000.0,2,'1403507414000.0','1403507414000.0');
INSERT INTO pyrdpserver.vm(vmId ,userName,vmName, ip,state,stateTime,userId,createTime , lastModifyTime) VALUES('2', 'vm2','vm2','192.168.1.107',0,1403507414000.0,2,'1403507414000.0','1403507414000.0');
...
INSERT INTO pyrdpserver.vm(vmId ,userName,vmName, ip,state,stateTime,userId,createTime , lastModifyTime) VALUES('4', 'vm4','vm4','192.168.1.107',0,1403507414000.0,3,'1403507414000.0','1403507414000.0');
...
CREATE TABLE pyrdpserver.actionType(id  INT PRIMARY KEY auto_increment, type INT, actionName varchar(32) );
...
#actionId:1/2
CREATE TABLE pyrdpserver.userLog(id  INT PRIMARY KEY auto_increment, type INT, userId INT ,ip varchar(32),actionTime varchar(32));
...
#actionId:3/4
CREATE TABLE pyrdpserver.userConn(id  INT PRIMARY KEY auto_increment, type INT, userId INT ,vmId INT ,ip varchar(32),actionTime varchar(32));
...
#actionId:5/6/7/8
CREATE TABLE pyrdpserver.userVmLog(id  INT PRIMARY KEY auto_increment, type INT, userId INT ,userVmId INT,ip varchar(32),actionTime varchar(32));
...
#actionId:9/10
CREATE TABLE pyrdpserver.userVmAction(id  INT PRIMARY KEY auto_increment, type INT, userId INT ,toUserId INT,vmId INT ,ip varchar(32),actionTime varchar(32));
